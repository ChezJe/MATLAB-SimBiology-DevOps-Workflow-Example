...
&emsp;[Part 1:  Getting the workshop files and configuring GitHub for automated testing and results publishing](#TMP_1229)
 
&emsp;[Part 2:  Generating your first tests](#TMP_4e93)
 
&emsp;[Part 3:  Finding existing tests and measuring coverage](#TMP_3f21)
 
&emsp;[Part 4:  Updating badges, committing our changes, and pushing to GitHub](#TMP_11a6)
 
&emsp;[Part 5:  Create a pull request, watch GitHub Actions automatically test your changes and publish results](#TMP_585c)
 
&emsp;[Part 6:  Compile the App in the CI workflow and download the artifact](#TMP_03f8)
 
&emsp;[Workshop wrap\-up and additional information](#TMP_8c61)
