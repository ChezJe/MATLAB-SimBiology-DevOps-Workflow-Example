...
&emsp;[Part 1:  Getting the workshop files and configuring GitHub for automated testing and results publishing](#TMP_71a3)
 
&emsp;[Part 2:  Generating your first tests](#TMP_39e1)
 
&emsp;[Part 3:  Finding existing tests and measuring coverage](#TMP_9a8b)
 
&emsp;[Part 4:  Updating badges, committing our changes, and pushing to GitHub](#TMP_8100)
 
&emsp;[Part 5:  Create a pull request, watch GitHub Actions automatically test your changes and publish results](#TMP_8979)
 
&emsp;[Part 6:  Compile the App in the CI workflow and download the artifact](#TMP_720e)
 
&emsp;[Workshop wrap\-up and additional information](#TMP_3054)
